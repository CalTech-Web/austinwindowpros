...
export const metadata: Metadata = {
  title: "Window & Door Replacement in Dripping Springs, TX",
  description:
    "Austin Window Pros serves Dripping Springs, TX with professional window and door replacement. Locally owned since 1992. Custom measured, Energy Star products, free quotes.",
  alternates: {
    canonical: "https://austinwindowpros.com/locations/dripping-springs/",
  },
  openGraph: {
    title: "Window & Door Replacement in Dripping Springs, TX | Austin Window Pros",
    description:
      "Austin Window Pros serves Dripping Springs, TX with professional window and door replacement. Locally owned since 1992. Free quotes and financing available.",
    url: "https://austinwindowpros.com/locations/dripping-springs/",
    type: "website",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Dripping Springs", item: "https://austinwindowpros.com/locations/dripping-springs/" },
  ],
};
...
const localServiceSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Window and Door Replacement in Dripping Springs, TX",
  provider: {
    "@type": "LocalBusiness",
  ...
  description:
    "Professional window and door replacement for Dripping Springs, TX homeowners. Custom measured windows and doors, Energy Star certified products, and professional installation.",
};
...
const faqSchema = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "Do you replace windows and doors in Dripping Springs, TX?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes. Austin Window Pros serves Dripping Springs and the surrounding Hill Country area with window replacement, door replacement, siding, and outdoor enclosures. David Adams personally handles every consultation.",
      },
    },
    {
      "@type": "Question",
      name: "How do I get a free quote in Dripping Springs?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Call (512) 422-1907 or submit our contact form to schedule a free in-home consultation. We come to your Dripping Springs home, measure your windows and doors, and provide a no-pressure quote.",
      },
    },
    {
      "@type": "Question",
      name: "What window brands do you install in Dripping Springs?",
      acceptedAnswer: {
        "@type": "Answer",
...
export default function DrippingSpringsPage() {
  return (
    <>
      ...
      <section className="relative overflow-hidden min-h-[400px] flex items-center" style={{ backgroundColor: "#1a3a5c" }}>
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/gallery/project-22.jpg"
            alt="Window installation project in Dripping Springs TX"
            fill
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold mb-3" style={{ fontFamily: "var(--font-overpass)" }}>
            Window &amp; Door Replacement in Dripping Springs, TX
          </h1>
          <p className="text-lg opacity-90 max-w-2xl">
            Locally owned since 1992. David Adams serves Dripping Springs homeowners personally, from the first call through the final inspection.
          </p>
      ...
      {/* Why we serve Dripping Springs */}
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-extrabold mb-6" style={{ color: "#1a3a5c", fontFamily: "var(--font-overpass)" }}>
            Serving Dripping Springs Since 1992
          </h2>
          <p className="mb-4 leading-relaxed" style={{ color: "#374151" }}>
            Dripping Springs sits at the gateway to the Texas Hill Country, and the homes here range from newer construction in master-planned communities to established properties on larger acreage lots. Austin Window Pros has served Dripping Springs and the surrounding Hays County area since 1992, bringing the same precision craftsmanship that homeowners across Central Texas have trusted for over 30 years.
          </p>
          <p className="mb-4 leading-relaxed" style={{ color: "#374151" }}>
            Every window and door we install in Dripping Springs is custom measured to your exact opening. No standard sizes, no filler material, no gaps. David Adams personally handles every consultation, bringing over 40 years of hands-on experience to every job from the first call through the final walkthrough.
          </p>
          <p className="leading-relaxed" style={{ color: "#374151" }}>
            We install Energy Star certified windows and doors rated for the Southern climate zone, built to perform in the intense Hill Country heat. Financing is available with fast, one-click approvals for qualifying customers.
          </p>
        </div>
      </section>
