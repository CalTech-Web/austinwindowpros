...
export const metadata: Metadata = {
  title: "Window & Door Replacement in Georgetown, TX",
  description:
    "Austin Window Pros serves Georgetown, TX with professional window and door replacement. Locally owned since 1992. Custom measured, Energy Star products, free quotes.",
  alternates: {
    canonical: "https://austinwindowpros.com/locations/georgetown/",
  },
  openGraph: {
    title: "Window & Door Replacement in Georgetown, TX | Austin Window Pros",
    description:
      "Austin Window Pros serves Georgetown, TX with professional window and door replacement. Locally owned since 1992. Free quotes and financing available.",
    url: "https://austinwindowpros.com/locations/georgetown/",
    type: "website",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Georgetown", item: "https://austinwindowpros.com/locations/georgetown/" },
  ],
};
...
const localServiceSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Window and Door Replacement in Georgetown, TX",
  provider: {
    "@type": "LocalBusiness",
  ...
  description:
    "Professional window and door replacement for Georgetown, TX homeowners. Custom measured windows and doors, Energy Star certified products, and professional installation.",
};
...
const faqSchema = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "Do you replace windows and doors in Georgetown, TX?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes. Austin Window Pros serves Georgetown and all of Williamson County with window replacement, door replacement, siding, and outdoor enclosures. David Adams personally handles every consultation.",
      },
    },
    {
      "@type": "Question",
      name: "How do I get a free quote in Georgetown?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Call (512) 422-1907 or submit our contact form to schedule a free in-home consultation. We come to your Georgetown home, measure your windows and doors, and provide a no-pressure quote.",
      },
    },
    {
      "@type": "Question",
      name: "What window brands do you install in Georgetown?",
      acceptedAnswer: {
        "@type": "Answer",
...
export default function GeorgetownPage() {
  return (
    <>
      ...
      <section className="relative overflow-hidden py-14" style={{ backgroundColor: "#1a3a5c" }}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold mb-3" style={{ fontFamily: "var(--font-overpass)" }}>
            Window &amp; Door Replacement in Georgetown, TX
          </h1>
          <p className="text-lg opacity-90 max-w-2xl">
            Locally owned since 1992. David Adams serves Georgetown homeowners personally, from the first call through the final inspection.
          </p>
      ...
      {/* Why we serve Georgetown */}
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-extrabold mb-6" style={{ color: "#1a3a5c", fontFamily: "var(--font-overpass)" }}>
            Serving Georgetown Since 1992
          </h2>
          <p className="mb-4 leading-relaxed" style={{ color: "#374151" }}>
            Georgetown has been one of the fastest-growing cities in Texas for years, and Austin Window Pros has been serving homeowners here since 1992. Homes in Georgetown range from older properties near the historic square to newer construction in master-planned communities, and each requires the same attention to precision fit and energy performance.
          </p>
          <p className="mb-4 leading-relaxed" style={{ color: "#374151" }}>
            Every window and door we install in Georgetown is custom measured to your exact opening. No stock sizing, no shortcuts. David Adams personally handles every consultation and is accountable for every installation. Georgetown homeowners get the same level of care and accountability as every other community we serve.
          </p>
          <p className="leading-relaxed" style={{ color: "#374151" }}>
            We install Energy Star certified windows and doors rated for the Southern climate zone, which means they are tested and verified to perform in the heat and humidity conditions common across Williamson County. Financing is available with fast, one-click approvals for qualifying customers.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-extrabold mb-10 text-center" style={{ color: "#1a3a5c", fontFamily: "var(--font-overpass)" }}>
            Services Available in Georgetown
          </h2>
