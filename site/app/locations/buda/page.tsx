...
export const metadata: Metadata = {
  title: "Window & Door Replacement in Buda, TX",
  description:
    "Austin Window Pros serves Buda, TX with professional window and door replacement. Locally owned since 1992. Custom measured, Energy Star products, free quotes.",
  alternates: {
    canonical: "https://austinwindowpros.com/locations/buda/",
  },
  openGraph: {
    title: "Window & Door Replacement in Buda, TX | Austin Window Pros",
    description:
      "Austin Window Pros serves Buda, TX with professional window and door replacement. Locally owned since 1992. Free quotes and financing available.",
    url: "https://austinwindowpros.com/locations/buda/",
    type: "website",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Buda", item: "https://austinwindowpros.com/locations/buda/" },
  ],
};
...
const localServiceSchema = {
  "@context": "https://schema.org",
  "@type": "Service",
  name: "Window and Door Replacement in Buda, TX",
  provider: {
    "@type": "LocalBusiness",
  ...
  description:
    "Professional window and door replacement for Buda, TX homeowners. Custom measured windows and doors, Energy Star certified products, and professional installation.",
};
...
const faqSchema = {
  ...
  mainEntity: [
    {
      "@type": "Question",
      name: "Do you replace windows and doors in Buda, TX?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Yes. Austin Window Pros serves Buda and the surrounding Hays County area with window replacement, door replacement, siding, and outdoor enclosures. David Adams personally handles every consultation.",
      },
    },
    {
      "@type": "Question",
      name: "How do I get a free quote in Buda?",
      acceptedAnswer: {
        "@type": "Answer",
        text: "Call (512) 422-1907 or submit our contact form to schedule a free in-home consultation. We come to your Buda home, measure your windows and doors, and provide a no-pressure quote.",
      },
    },
    {
      "@type": "Question",
      name: "What window brands do you install in Buda?",
      acceptedAnswer: {
        "@type": "Answer",
      ...
      <section className="relative overflow-hidden min-h-[400px] flex items-center" style={{ backgroundColor: "#1a3a5c" }}>
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Window installation project in Buda TX"
            fill
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white text-center">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold mb-3" style={{ fontFamily: "var(--font-overpass)" }}>
            Window &amp; Door Replacement in Buda, TX
          </h1>
          <p className="text-lg opacity-90 max-w-2xl mx-auto">
            Locally owned since 1992. David Adams serves Buda homeowners personally, from the first call through the final inspection.
          </p>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-extrabold mb-6" style={{ color: "#1a3a5c", fontFamily: "var(--font-overpass)" }}>
            Serving Buda Since 1992
          </h2>
          <p className="mb-4 leading-relaxed" style={{ color: "#374151" }}>
            Buda has grown rapidly as one of Austin's most popular southern suburbs, and Austin Window Pros has been serving homeowners in this area since 1992. Whether your home was built decades ago or in one of Buda's many newer subdivisions, the Texas heat makes energy-efficient windows and doors one of the smartest upgrades you can make.
          </p>
          <p className="mb-4 leading-relaxed" style={{ color: "#374151" }}>
            Every window and door we install in Buda is custom measured to your exact opening. No stock sizing, no compromise on fit. David Adams personally handles every consultation and holds the crew accountable to the same standards that have kept Austin Window Pros in business for over three decades.
          </p>
          <p className="leading-relaxed" style={{ color: "#374151" }}>
            We install Energy Star certified windows and doors rated for the Southern climate zone, providing maximum heat rejection and efficiency in the Hays County area. Financing is available with fast, one-click approvals for qualifying customers.
          </p>
        </div>
      </section>
